    ...
    <header class="header-top">
        <nav class="navbar navbar-light">
            <div class="navbar-left">
                ...
                <a class="navbar-brand" href="javascript:void(0)"><img class="svg dark" src="<?php echo base_url(); ?>assets/employee/img/Nimbus_Logo.jpg" alt="svg"><img class="light" src="<?php echo base_url(); ?>assets/employee/img/Nimbus_Logo.jpg" alt="img"></a>
