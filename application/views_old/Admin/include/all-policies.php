        ...
        <div class="contents demo-card expanded">
            ...
            <div class="container-fluid">
                <div class="social-dash-wrap">
                                ...
                                <div class="breadcrumb-main user-member justify-content-sm-between ">
                                    <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                                        <div class="d-flex align-items-center user-member__title justify-content-center mr-sm-25">
                                            <h4 class="text-capitalize fw-500 breadcrumb-title">List All Policies</h4>
                                        </div>
                                    ...
                                    <div class="card-extra">
                                        <a href="policies.html" class="btn px-15 btn-primary">
                    ...
                    <div class="knowledgebase-details knowledgebase-details--row mt-0">
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-md-6">
                                        <div class="card knowledgebase__article bg-primary mb-30">
                                            <div class="card-body">
                                                <span>Article</span>
                                                <h3>Learn everything you need to know getting help with Lorem Ipsum</h3>
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        ...
                                        <div class="card knowledgebase__article bg-info mb-30">
                                            <div class="card-body">
                                                <span>Article</span>
                                                <h3>Does Lorem comply with the General Data Protection Regulation for EU customers?</h3>
                                                <div class="knowledgebase__article-more">
                                                    <a href="#">read more <i class="las la-arrow-right"></i></a>
                                                </div>
                                            </div>
