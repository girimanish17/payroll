                        ...
                        <div class="user-group px-30 pt-30 pb-25 radius-xl bg-white">
                            <div class="media user-group-media d-flex justify-content-between">
                                <div class="media-body d-flex align-items-center">
                                    <img class="mr-20 wh-70 rounded-circle bg-opacity-primary" src="img/author-nav.jpg" alt="author">
                                    <div>
                                        <a href="application-ui.html">
                                            <h6 class="mt-0  fw-500">Alok Dixit</h6>
                                        </a>
                                        <p class="fs-13 color-light mb-0">Tech</p>
                                    </div>
                                </div>
                                <div class="mt-n15">
                            ...
                            <div class="user-group-people">
                                ...
                                <ul class="d-flex flex-wrap mb-20 user-group-people__parent">
                                    <li>
                                        <a href="#"><img class="rounded-circle wh-34 bg-opacity-secondary" src="img/author-nav.jpg" alt="author"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="rounded-circle wh-34 bg-opacity-secondary" src="img/author-nav.jpg" alt="author"></a>
                                    </li>
                            ...
                            <div class="media user-group-media d-flex justify-content-between">
                                <div class="media-body d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="fs-13 color-light mb-0">Admin</p>
                                    </div>
                                </div>
                                <div class="mt-n15">
                                    <div class="dropdown dropdown-click">
                            ...
                            <div class="media user-group-media d-flex justify-content-between">
                                <div class="media-body d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="fs-13 color-light mb-0">Sales</p>
                                    </div>
                                </div>
                                <div class="mt-n15">
                                    <div class="dropdown dropdown-click">
