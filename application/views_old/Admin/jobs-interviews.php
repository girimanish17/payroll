                            ...
                            <div class="userDatatable adv-table-table global-shadow border-0 bg-white w-100 adv-table">
                                <div class="table-responsive">
                                    <div class="card-header border-bottom">
                                        <h5 class=" color-dark fw-600">List All Interviews</h5>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <table class="table mb-0 table-borderless adv-table" data-sorting="true" data-filter-container="#filter-form-container" data-paging-current="1" data-paging-position="right" data-paging-size="10">
                                            <thead>
                                                <tr class="userDatatable-header">
                                                    ...
                                                    <th> <span class="userDatatable-title">Selected Condidate Name</span> </th>
                                                    <th> <span class="userDatatable-title">Email Id</span> </th>
                                                    <th> <span class="userDatatable-title">Place of Interview</span> </th>
                                                    <th> <span class="userDatatable-title">Interview Time</span> </th>
                                                    <th> <span class="userDatatable-title">Interviewer Name</span> </th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="userDatatable-inline-title">
                                                            <h6 class="text-primary"> 12:00 PM<br> <span class="text-muted fs-12">31 May 2022</span></h6>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="userDatatable-inline-title">
                                                    ...
                                                    <td>
                                                        <div class="userDatatable-inline-title">
                                                            <h6>
                                                                <span class="atbd-tag tag-success tag-transparented">Passed Interview</span>
                                                            </h6>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="userDatatable-inline-title">
                                                            <h6 class="text-primary"> 05:00 PM<br> <span class="text-muted fs-12">29 May 2022</span></h6>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="userDatatable-inline-title">
                                                    ...
                                                    <td>
                                                        <div class="userDatatable-inline-title">
                                                            <h6>
                                                                <span class="atbd-tag tag-warning tag-transparented">On Hold</span>
                                                            </h6>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="userDatatable-inline-title">
                                                            <h6 class="text-primary"> 11:00 AM<br> <span class="text-muted fs-12">26 May 2022</span></h6>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="userDatatable-inline-title">
                                                    ...
                                                    <td>
                                                        <div class="userDatatable-inline-title">
                                                            <h6>
                                                                <span class="atbd-tag tag-danger tag-transparented">Rejected</span>
                                                            </h6>
                                                        </div>
                                                    </td>
                                                    <td>
