		  ...
		  <?php echo $this->session->flashdata('msg');
            ...
            <div class="form-row">
               ...
               <div class="col-sm-4 form-group">
                  ...
                  <input type="text" value="<?php echo $employees['emp_id'] ?>" name="emp_id" placeholder="Employee Id" class="form-control" required>
               </div>
               <div class="form-group col-sm-4">
                  <div class="with-icon">
               ...
               <div class="form-group col-sm-4">
                  <div class="with-icon">
                     <span class="la la-money-check-alt color-light"></span>
                     <input type="text" value="<?php echo $bankDetail['bin']; ?>" name="bin" class="form-control  ih-medium ip-lightradius-xs b-light" id="=" placeholder="Bank Identifier code">
                  </div>
               </div>
               <div class="form-group col-sm-4">
                  <div class="with-icon">
