													...
													<form action="<?php echo base_url(); ?>superadmin/editmarrital_status/<?php echo $value['id']; ?>" method="post" id="companyForm2" enctype="multipart/form-data">
														<div class="form-row">
															...
															<div class="form-group col-sm-12">
																...
																<input type="text" name="marrital_status"  value="<?php echo $value['marrital_status'];?>" class="form-control ih-medium ip-gray radius-xs b-light px-15"  placeholder="Enter Marrital Status">
															</div>
