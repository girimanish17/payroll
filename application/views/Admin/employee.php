            ...
            <div class="card">
               <div class="card-header">
                  ...
                  <div class="card-extra">
					 ...
					 <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#new-member" style="margin-left: 5px;">
                        <i class="las la-plus fs-16"></i>Import Employees
					 </a>
										 <!-- Modal -->
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content  radius-xl">
                                                <div class="modal-header">
                                                    <h6 class="modal-title fw-500" id="staticBackdropLabel">Bulk Employees Import by CSV</h6>
                                                ...
                                                <div class="modal-body">
                                                    <div class="new-member-modal">
                                                        <form method="post" id="importForm" action="<?= base_url() ?>admin/importEmp" enctype="multipart/form-data">
                                                            <div id="msg"> </div>
                                                            <div class="form-group mb-20">
                                                                <input  type="file" name="csv_file" id="csv_file" required>
																<a href="<?php echo base_url('admin/download'); ?>" id="format_type" download="">Download Sample CSV</a>
                                                            </div>
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             ...
                                             <!--<a href="<?php echo base_url(); ?>admin/leaveMangEmployee/<?php echo $value['user_id']; ?>" class="btn btn-default btn-primary btn-circle pl-2 pr-2 mr-2">L</a>-->
