                            ...
                            <div class="userDatatable adv-table-table global-shadow border-0 bg-white w-100 adv-table">
                                <div class="table-responsive">
                                    <div class="card-header border-bottom">
                                        <h5 class=" color-dark fw-600">List All Track Goals (OKRs)</h5>
                                        ...
                                        <table class="table mb-0 table-borderless adv-table" data-sorting="true" data-filter-container="#filter-form-container" data-paging-current="1" data-paging-position="right" data-paging-size="10">
                                            <thead>
                                                <tr class="userDatatable-header">
                                                    <th> <span class="userDatatable-title">Goal Type</span> </th>
                                                    <th> <span class="userDatatable-title">Subject</span> </th>
                                                    <th> <span class="userDatatable-title">Start Date</span> </th>
                                                    <th> <span class="userDatatable-title">End Date</span> </th>
                                                    <th> <span class="userDatatable-title">Goal Rating</span> </th>
                                                    <th> <span class="userDatatable-title">Progress</span> </th>
                                                </tr>
                                            </thead>
                                            <tbody>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content  radius-xl">
                <div class="modal-header">
                    <h6 class="modal-title fw-500" id="staticBackdropLabel">Add New Goal</h6>
                        ...
                        <form>
                            <div class="form-row">
                                <div class="form-group col-md-6 mb-2">
                                    <label class="il-gray fs-14 fw-500 align-center">Goal Type  <span class="text-danger">*</span></label>
                                ...
                                <div class="form-group col-md-6 form-group-calender">
                                    <label class="il-gray fs-14 fw-500 align-center">Subject  <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control  ih-medium ip-lightradius-xs b-light" placeholder="Subject">
                                </div>

                                <div class="form-group col-md-4 form-group-calender">
                                    <label class="il-gray fs-14 fw-500 align-center">Target Achievement <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control  ih-medium ip-lightradius-xs b-light" placeholder="Target Achievement">
                                </div>
                                <div class="col-md-4 form-group-calender">
                                ...
                                <div class="col-md-12 form-group-calender">
                                    <label>Description</label>
                                    <textarea class="form-control  ih-medium ip-light radius-xs b-light px-15" rows="4"></textarea>
                                </div>
                            </div>
