													...
													<form action="<?php echo base_url(); ?>superadmin/editbulletin_category/<?php echo $value['id']; ?>" method="post" id="companyForm2" enctype="multipart/form-data">
														<div class="form-row">
															...
															<div class="form-group col-sm-12">
																...
																<input type="text" name="bulletin_category"  value="<?php echo $value['description'];?>" class="form-control ih-medium ip-gray radius-xs b-light px-15"  placeholder="Enter Bulletin Category">
															</div>
			...
			<div class="Vertical-form">
				<form action="<?php echo base_url(); ?>superadmin/addbulletin_category" method="post" id="companyForm" enctype="multipart/form-data">
					<div class="form-row">
						...
						<div class="form-group col-sm-12">
							<label> Bulletin Category</label>
							<input type="text" name="bulletin_category" value="<?php echo set_value('bulletin_category') ?>" class="form-control ih-medium ip-gray radius-xs b-light px-15"  placeholder="Enter Bulletin Category">
						</div>
