                                ...
                                <div class="d-flex justify-content-between border-0 radius-xl">
                                    <div class="application-task d-flex align-items-center">
                                        <div class="application-task-icon wh-50 mr-15 bg-primary content-center">
                                            <i class="fas fa-money-check-alt text-white font-size-20"></i>
                                        </div>
                                        <div class="application-task-content">
                                            <h5>Accounts</h5>
                                            <span class="text-light fs-13 mt-1 text-capitalize">Add Accounts</span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                                ...
                                <div class="d-flex justify-content-between border-0 radius-xl">
                                    <div class="application-task d-flex align-items-center">
                                        <div class="application-task-icon wh-50 mr-15 bg-secondary content-center">
                                            <i class="fas fa-dollar-sign text-white font-size-20"></i>
                                        </div>
                                        <div class="application-task-content">
                                            <h5>Deposit</h5>
                                            <span class="text-light fs-13 mt-1 text-capitalize">Add Deposit</span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                                ...
                                <div class="d-flex justify-content-between border-0 radius-xl">
                                    <div class="application-task d-flex align-items-center">
                                        <div class="application-task-icon wh-50 mr-15 bg-success  content-center">
                                            <i class="fas fa-file-invoice-dollar text-white font-size-20"></i>
                                        </div>
                                        <div class="application-task-content">
                                            <h5>Expense</h5>
                                            <span class="text-light fs-13 mt-1 text-capitalize">Add Expense</span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                                ...
                                <div class="d-flex justify-content-between border-0 radius-xl">
                                    <div class="application-task d-flex align-items-center">
                                        <div class="application-task-icon wh-50 mr-15 bg-warning content-center">
                                            <i class="fas fa-donate text-white font-size-20"></i>
                                        </div>
                                        <div class="application-task-content">
                                            <h5>Transactions</h5>
                                            <span class="text-light fs-13 mt-1 text-capitalize">View All Transactions</span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            ...
                            <div class="userDatatable adv-table-table global-shadow border-0 bg-white w-100 adv-table">
                                <div class="table-responsive">
                                    <div class="card-header border-bottom">
                                        <h5 class=" color-dark fw-600">List All Accounts</h5>
                                        ...
                                        <table class="table mb-0 table-borderless adv-table" data-sorting="true" data-filter-container="#filter-form-container" data-paging-current="1" data-paging-position="right" data-paging-size="10">
                                            <thead>
                                                <tr class="userDatatable-header">
                                                    <th> <span class="userDatatable-title">Account Title</span> </th>
                                                    <th> <span class="userDatatable-title">Account Number</span> </th>
                                                    <th> <span class="userDatatable-title">Balance</span> </th>
                                                    <th> <span class="userDatatable-title">Bank Branch</span> </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <div class="userDatatable__imgWrapper d-flex align-items-center">
                                                                <img class="profile-image rounded-circle d-block m-0 wh-38" src="img/author/icici.png" alt="" />
                                                            </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            <div class="userDatatable__imgWrapper d-flex align-items-center">
                                                                <img class="profile-image rounded-circle d-block m-0 wh-38" src="img/author/axis.png" alt="" />
                                                            </div>
                                                            <div class="userDatatable-inline-title">
                                                                <h6>AXIS Bank</h6>
                                                            </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                            <div class="userDatatable__imgWrapper d-flex align-items-center">
                                                                <img class="profile-image rounded-circle d-block m-0 wh-38" src="img/author/hdfc.png" alt="" />
                                                            </div>
                                                            <div class="userDatatable-inline-title">
                                                                <h6>HDFC Bank</h6>
                                                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content  radius-xl">
                <div class="modal-header">
                    <h6 class="modal-title fw-500" id="staticBackdropLabel">Add New Account </h6>
                        ...
                        <form>
                            <div class="form-row">
                                <div class="form-group col-md-6 mb-2">
                                    <label class="il-gray fs-14 fw-500 align-center">Account Title <span class="text-danger">*</span></label>
                                    <div class="with-icon">
                                        <span class="la la-landmark lar color-light"></span>
                                        <input type="text" class="form-control  ih-medium ip-lightradius-xs b-light" id="inputNameIcon" placeholder="Enter Account Title">
                                    </div>
                                </div>
                                <div class="form-group col-md-6 form-group-calender">
                                    <label class="il-gray fs-14 fw-500 align-center">Initial Balance <span class="text-danger">*</span></label>
                                    <div class="with-icon">
                                        <span class="la la-rupee-sign lar color-light"></span>
                                        <input type="text" class="form-control  ih-medium ip-lightradius-xs b-light" placeholder="Enter Initial Balance">
                                    </div>
                                </div>
                                <div class="form-group col-md-6 form-group-calender">
                                    <label class="il-gray fs-14 fw-500 align-center">Account Number <span class="text-danger">*</span></label>
                                    <div class="with-icon">
                                        <span class="la la-user-check lar color-light"></span>
                                        <input type="text" class="form-control  ih-medium ip-lightradius-xs b-light" placeholder="Enter Account Number">
                                    </div>
                                </div>
                                <div class="form-group col-md-6 form-group-calender">
                                    <label class="il-gray fs-14 fw-500 align-center">Branch Code <span class="text-danger">*</span></label>
                                    <div class="with-icon">
                                        <span class="la la-location-arrow lar color-light"></span>
                                        <input type="text" class="form-control  ih-medium ip-lightradius-xs b-light" placeholder="Enter Branch Code">
                                    </div>
                                </div>
                                <div class="form-group col-md-12 form-group-calender">
                                    <label class="il-gray fs-14 fw-500 align-center">Bank Branch <span class="text-danger">*</span></label>
                                    <textarea class="form-control  ih-medium ip-lightradius-xs b-light" placeholder="Bank Branch"></textarea>
                                </div>
                            </div>
