                ...
                <div class="row">
                            ...
                            <div class="userDatatable adv-table-table global-shadow border-0 bg-white w-100 adv-table">
                                <div class="table-responsive">
                                    <div class="card-header border-bottom">
                                        <h5 class=" color-dark fw-600">List All Goal Types</h5>
                                    </div>
                                        ...
                                        <table class="table mb-0 table-borderless adv-table border" data-sorting="true" data-filter-container="#filter-form-container" data-paging-current="1" data-paging-position="right" data-paging-size="10">
                                            <thead>
                                                <tr class="userDatatable-header">
                                                    <th> <span class="userDatatable-title"><i class="la la-braille"></i> Goal Type</span> </th>
                    ...
                    <div class="col-md-4 col-sm-5">
                        <div class="card border">
                            <div class="card-header border-bottom">
                                <h5>Add New Goal Type</h5>
                            </div>
                            <div class="card-body">
                                <form action="#">
                                    <div class="form-group">
                                        <label for="Goal" class="il-gray fs-14 fw-500 align-center">Goal Type  <span class="text-danger">*</span></label>
                                        <div class="with-icon">
                                            <span class="la la-podcast color-light"></span>
                                            <input type="text" class="form-control  ih-medium ip-lightradius-xs b-light" id="Goal" placeholder="Goal Type">
                                        </div>
                                    </div>
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content" id="ajax_view_modal">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Goal Type Information
                ...
                <div class="modal-body">
                    ...
                    <form action="#">
                        <div class="form-group">
                            <label for="goal" class="il-gray fs-14 fw-500 align-center">Goal Type  <span class="text-danger">*</span></label>
                            <div class="with-icon">
                                <span class="la-podcast la color-light"></span>
                                <input type="text" class="form-control  ih-medium ip-lightradius-xs b-light" id="goal" placeholder="lkhgds kjhg">
                            </div>
                        </div>
