                                                    ...
                                                    <td>
                                                        <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
														   ...
														   <?php }else{?>  
														    <li>
                                                                <a href="#" class="edit">
                                                                    <span data-feather="edit" onclick="return confirm('This is not editable!')" disabled data-toggle="modal" data-target="#add_newaa"></span></a>
																	 
                                                            </li>
															 <li>
                                                                <a onclick="return confirm('This is not deletable!')" disabled class="remove"><span data-feather="trash-2"></span></a>
                                                            </li>
