			...
			<div class="Vertical-form">
				<form action="<?php echo base_url(); ?>superadmin/addprofession_tax_slabs" method="post" id="companyForm" enctype="multipart/form-data">
                  ...
                  <label>Deduction Month:</label>
                     <select name="deduction_month" id=""  class="form-control  ih-medium ip-lightradius-xs b-light" required>
                    <option value="">Select Month</option>
                     <option value="January" <?php if (set_value('deduction_month') == 'January') {echo 'selected';}?>>January</option>
                     <option value="February" <?php if (set_value('deduction_month') == 'February') {echo 'selected';}?>>February</option>
                     <option value="March" <?php if (set_value('deduction_month') == 'March') {echo 'selected';}?>>March</option>
                     <option value="April" <?php if (set_value('deduction_month') == 'April') {echo 'selected';}?>>April</option>
                     <option value="May" <?php if (set_value('deduction_month') == 'May') {echo 'selected';}?>>May</option>
                     <option value="June" <?php if (set_value('deduction_month') == 'June') {echo 'selected';}?>>June</option>
                     <option value="July" <?php if (set_value('deduction_month') == 'July') {echo 'selected';}?>>July</option>
                     <option value="August" <?php if (set_value('deduction_month') == 'August') {echo 'selected';}?>>August</option>
                     <option value="September" <?php if (set_value('deduction_month') == 'September') {echo 'selected';}?>>September</option>
                     <option value="October" <?php if (set_value('deduction_month') == 'October') {echo 'selected';}?>>October</option>
                     <option value="November" <?php if (set_value('deduction_month') == 'November') {echo 'selected';}?>>November</option>
                     <option value="December" <?php if (set_value('deduction_month') == 'December') {echo 'selected';}?>>December</option>
