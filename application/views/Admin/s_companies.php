                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-social" id="tblUser">
                                        ...
                                        <tbody>
										<?php $i = 1;if($admin){ foreach($admin as $key => $value){
                                            ...
                                            <tr>
												...
												<td><img src="<?php echo base_url('assets/images/users/'.$admins['profile_img']);?>" width="60"></td>
											...
											<div class="modal-dialog modal-md" role="document">
												<div class="modal-content modal-bg-white ">
													...
													<div class="modal-body">
														<div class="Vertical-form">
															<form action="<?php echo base_url(); ?>superadmin/editCompanies/<?php echo $value['user_id']; ?>" method="post" id="companyForm2" enctype="multipart/form-data">
																<div class="form-row">
																	<div class="account-profile border-bottom form-group col-md-12 text-center pb-4">
																		...
																		<img class="ap-img__main" style="height:118px;width:118px;" id="blah" src="<?php echo base_url('assets/images/users/'.$admins['profile_img']);?>" alt="profile">
																			</br>		
																		
																			<!--<input id="imgInp" type="file" accept="image/*" name="image" >
																			
																			<label for="imgInp" class="mb-0">
																				
																				<figure class="mb-0">
																					<img class="ap-img__main" style="height:118px;width:118px;" id="blah" src="<?php echo base_url('assets/images/users/'.$value['logo']);?>" alt="profile">
																		...
																		<input type="file"  name="image" style="padding-left: 207px;padding-bottom: 14px;">
																		<h5>
																	...
																	<div class="form-group col-sm-12">
																		...
																		<input type="text" name="first_name" value="<?php echo $value['first_name'];?>" class="form-control ih-medium ip-gray radius-xs b-light px-15"  placeholder="Enter First Name">
																	</div>
																	<div class="form-group col-sm-12">
																		<label> Last Name</label>
																		<input type="text" name="last_name" value="<?php echo $value['last_name'];?>" class="form-control ih-medium ip-gray radius-xs b-light px-15"  placeholder="Enter Last Name">
																	</div>
																	<div class="form-group col-sm-12">
																		<label> Email</label>
																		<input type="email" name="email" value="<?php echo $value['email'];?>" class="form-control ih-medium ip-gray radius-xs b-light px-15"  placeholder="Enter Email">
																	</div>
																	<!--<div class="form-group col-sm-12">
																		<label> Password</label>
																		<input type="password" name="password"  value="<?php echo $value['password'];?>" class="form-control ih-medium ip-gray radius-xs b-light px-15"  placeholder="Enter Password">
																	</div>-->
																	<div class="form-group col-md-12">
																		<label>Package</label>
                    ...
                    <div class="Vertical-form">
                        <form action="<?php echo base_url(); ?>superadmin/addCompanies" method="post" id="companyForm" enctype="multipart/form-data">
                            <div class="form-row">
								...
								<div class="form-group col-sm-12">
                                    <label> First Name</label>
                                    <input type="text" name="first_name" class="form-control ih-medium ip-gray radius-xs b-light px-15"  placeholder="Enter First Name" value="<?php  echo set_value('first_name'); ?>">
                                </div>
								<div class="form-group col-sm-12">
                                    <label> Last Name</label>
                                    <input type="text" name="last_name" class="form-control ih-medium ip-gray radius-xs b-light px-15"  placeholder="Enter Last Name" value="<?php  echo set_value('last_name'); ?>">
                                </div>
								<div class="form-group col-sm-12">
                                    <label> Email</label>
                                    <input type="email" name="email" class="form-control ih-medium ip-gray radius-xs b-light px-15"  placeholder="Enter Email" value="<?php  echo set_value('email'); ?>">
                                </div>
								<div class="form-group col-sm-12">
                                    <label> Password</label>
