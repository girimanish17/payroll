                            ...
                            <div class="userDatatable adv-table-table global-shadow border-0 bg-white w-100 adv-table">
                                <div class="table-responsive">
                                    <div class="card-header border-bottom">
                                        <h5 class=" color-dark fw-600">List All Promoted Employees</h5>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <table class="table mb-0 table-borderless adv-table" data-sorting="true" data-filter-container="#filter-form-container" data-paging-current="1" data-paging-position="right" data-paging-size="10">
                                            <thead>
                                                <tr class="userDatatable-header">
                                                    ...
                                                    <th> <span class="userDatatable-title">Promotion Title</span> </th>
                                                    <th> <span class="userDatatable-title">Interviewer</span> </th>
                                                    <th> <span class="userDatatable-title">Promotion Date</span> </th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="userDatatable-inline-title">
                                                            <button class="btn btn-primary btn-sm text-white" role="button" data-target="#add_New" data-toggle="modal"><i class="la la-eye"></i>View Remark</button>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="userDatatable-inline-title">
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content  radius-xl">
                <div class="modal-header">
                    <h6 class="modal-title fw-500" id="staticBackdropLabel">View Interview Remarks</h6>
