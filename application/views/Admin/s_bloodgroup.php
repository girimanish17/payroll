										...
										<td>
											<div class="atbd-button-list d-flex flex-wrap">
											   <button class="btn btn-icon btn-success btn-squared" title="Edit" data-toggle="modal" data-target="#Edit_NewCompany<?php echo $i; ?>"><i class="la la-edit mr-0"></i></button>
												...
												<a onclick="return confirm('Are you sure want to change status of this bloodgroup?');" href="<?php echo base_url(); ?>superadmin/changeStatusBloodgroup/<?php echo $value['id'];?>/1"><button class="btn btn-icon btn-danger btn-squared" title="Enable" ><i class="la la-ban mr-0"></i></button></a>
												<?php }else{?>
