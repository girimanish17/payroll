                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class=" color-dark fw-600">List All Employee Exit</h5>
                                <div class="card-extra atbd-button-list">
                                    <a href="exit_type.html" class="btn btn-primary btn-sm text-white">
                                        <i class="la la-plus"></i> Exit Type
                                    </a>
                                        ...
                                        <table class="table mb-0 table-basic">
                                            <thead>
                                                <tr class="userDatatable-header">
                                                    <th><span class="userDatatable-title">Employee to Exit</span>
                                                    </th>
                                                    <th>
                                                        <span class="userDatatable-title">Exit Type</span>
                                                    </th>
                                                    <th>
                                                        <span class="userDatatable-title">Exit Date</span>
                                                    </th>
                                                    <th>
                                                        <span class="userDatatable-title">Exit Interview</span>
                                                    </th>
                                                    <th class="text-right">
                                                        <span class="userDatatable-title">Disable Account</span>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content" id="ajax_view_modal">
                <div class="modal-header">
                    <h5 class="modal-title">Add New Employee Exit</h5>
                ...
                <div class="modal-body">
                    ...
                    <form>
                        <div class="form-row">
                            ...
                            <div class="account-profile border-bottom form-group col-md-12 text-center pb-4">
                                ...
                                <h5>
                                    ...
                                    Exit Contract. Click above to upload.
                                </h5>
                                <p>
                                    <small>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <div class="mb-25  select-style2">
                                    <div class=" atbd-select ">
                                        ...
                                        <option selected="">Select Employee to Exit</option>
                                        <option>Alok Dixit</option>
                                        <option>Shubham Sathwane</option>
                                        <option>Ankur Kumar</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <div class="with-icon">
                                    <span class="la-calendar lar color-light"></span>
                                    <input type="text" class="form-control  ih-medium ip-lightradius-xs b-light" id="datepicker" placeholder="January 20, 2018">
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                <div class="mb-25  select-style2">
                                    <div class=" atbd-select ">
                                        <select name="select-alerts2" id="select-alerts2" class="form-control form-control-lg ih-medium ip-lightradius-xs b-light">
                                            <option selected="">Type of Exit</option> 
                            ...
                            <div class="form-group col-md-4">
                                <div class="with-icon">
                                    ...
                                    <select class="form-control ih-medium ip-lightradius-xs b-light">
                                        <option selected="">Exit Interview</option>
                                        <option>YES</option>
                                        <option>NO</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group col-md-4">
                                <div class="with-icon">
                                    ...
                                    <select class="form-control ih-medium ip-lightradius-xs b-light">
                                        <option selected="">Disable Account</option>
                                        <option>YES</option>
                                        <option>NO</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group col-md-12">
                                <textarea rows="6" class="form-control ip-lightradius-xs b-light" placeholder="Description"></textarea>
                            </div>
                        </div>
                    </form>
                </div>
