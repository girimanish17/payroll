                    ...
                    <div class="col-xxl-9 col-lg-9 col-md-9 col-sm-8 mb-25">
                        <div class="card mb-25">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        <h5 class="border-bottom pb-2 mb-4"><?php echo $job_position['position'];?></h5>
                                        <p><?php echo $job_position['description'];?></p>
            ...
            <div class="modal-content modal-bg-white ">
                ...
                <div class="modal-body">
                    <div class="Vertical-form">
                        <form method="post" action="<?php echo base_url('employee/job_application/'.$job_position['id']);?>"  enctype="multipart/form-data" >
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" required name="name" class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="Enter Full Name">
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                                <input type="email" required name="email" class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="Email Id">
                            </div>
                            <div class="form-group">
                                <label>Contact</label>
                                <input type="tel" required name="phone" class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="Enter Contact Number">
                            </div>
                            <div class="form-group">
                                <label>Cover</label>
                                <textarea class="form-control ip-light radius-xs b-light px-15" required name="cover" rows="3" placeholder="Cover Letter"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Upload Resume</label>
                                <input class="form-control ih-medium ip-light radius-xs b-light px-15" required name="file" type="file" id="formFile" accept="application/pdf">
                            </div>
