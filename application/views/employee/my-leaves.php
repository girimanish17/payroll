                            ...
                            <div class="card-footer bg-primary mt-2 text-center">
                                ...
                                <div class="profile-overview d-flex justify-content-between flex-wrap">
                                    <div class="po-details">
                                        <h6 class="po-details__title text-white"><?php echo $this->Common_function->attendenceInMonth($user_id);?>/<?php echo $this->Common_function->totalMonthdays();?></h6>
                                        <span class="po-details__sTitle text-white">Attendance</span>
                                    </div>
                                    <div class="po-details">
                                        <h6 class="po-details__title text-white"><?php echo $this->Common_function->leavesSumInYear($user_id);?>/<?php echo $this->Common_function->user_credit_leaves($user_id);?></h6>
                                        <span class="po-details__sTitle text-white">Full Leaves</span>
                                    </div>
                                    <div class="po-details">
                                        <h6 class="po-details__title text-white"><?php echo $this->Common_function->halfleavesSumInYear($user_id);?></h6>
