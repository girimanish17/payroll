...
function chartjsPieChartOne(selector) {
    ...
    if (ctx) {
        ...
        var chart = new Chart(ctx, {
            type: "pie",
            data: {
                labels: ["IOS", "PHP", "Design"],
                datasets: [{
                    data: [05, 30, 10],
                    backgroundColor: ["#ff69a5", "#fa8b0c", "#00cccc"],
                }, ],
            },
            options: {
                maintainAspectRatio: true,
...
function chartjsDoughnut(selector, cHeight, data) {
    var ctx = document.getElementById(selector);
	 //alert('Print php variable : '+ Pending +', '+Approved); 
    ...
    if (ctx) {
        ...
        var chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: data,
                    backgroundColor: ["#20C997", "#FA8B0C", "#ff69a5"],
                    total: "9,283",
                }, ],
            },
            options: {
...
chartjsDoughnut(
    "chartDoughnut2",
    "150",
    (data = [Approved_m, Pending_m, Rejected_m])   //month
);
...
$('#se_device-year-tab').on("shown.bs.tab", function() {
    chartjsDoughnut(
        "chartDoughnut2Y",
        "146",
        (data = [Approved, Pending, Rejected])   //year
    );
    $('#se_device-year-tab').off();
});

chartjsDoughnut("chartDoughnut3", "146", (data = [Approved_w, Pending_w, Rejected_w]));

$('#rb_device-week-tab').on("shown.bs.tab", function() {
    chartjsDoughnut(
        "chartDoughnut3W",
        "146",
        (data = [Approved_w, Pending_w, Rejected_w])
    );
