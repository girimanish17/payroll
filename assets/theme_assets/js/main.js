...
(function($) {
    ...
    function highlightRemoveForm(e) {
        if (!e.target.closest(".ap-post-form") &&
    ...
    /* Select */
    $("#countryOption,#cityOption,#skillsOption,#exampleFormControlSelect1,#select-countryOption,#Commissions,#Amount_One,#Amount_Two,#Deduction,#Reimbursement,#Gender,#Status,#Marital_Status,#Employee_Role,#Religion,#Blood_Group,#Nationality,#Citizenship,#Experience").select2({
