...
FooTable.MyFiltering = FooTable.Filtering.extend({
    ...
    $create: function() {
        ...
        var $status_form_grp = $('<div/>', { 'class': 'form-group atbd-select d-none align-items-center adv-table-searchs__position my-md-25 my-15 mr-sm-20 mr-0 ' })
        ...
        var $job_title_form_grp = $('<div/>', { 'class': 'form-group atbd-select d-flex align-items-center adv-table-searchs__status my-md-25 mt-5 mb-0 mr-sm-30 mr-0' })
